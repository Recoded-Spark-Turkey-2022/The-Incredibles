...
function BlogCard() {
  ...
  return (
    ...
    >
      <div className="transition-all duration-500 w-full h-1/4 bg-gray-200 border py-32 overflow-hidden group-hover:py-20"></div>
      ...
      <div className="w-full h-full flex flex-col justify-start p-2 mx-2 flex-wrap">
        ...
        <p className="font-medium overflow-hidden transition-all duration-900 h-6 pb-2 group-hover:h-fit group-hover:overflow-visible">
          testset tsetst lsakjdfl lsdjf lsdjf lksdjf ;lsakjdf lkdsjf lskdjf
          lsdkjg dlfkjg tsets jflsjglsak sldjf l;sdkjf sldkfj ld ;lskdjflsdjkf k
          lsdjkf lskf
        </p>
