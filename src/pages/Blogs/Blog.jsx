      ...
      <div className="flex flex-col m-auto w-1/2 max-lg:w-full items-center max-sm:p-2 max-lg:border-b-2 ">
        ...
        <div className=" relative border flex w-fit">
          ...
          <div className="w-fit h-fit absolute right-3 bottom-1">
            <img src={ShareIcon} alt="share-image" className="w-8 max-md:w-6 pt-8 max-sm:pt-6 " />
            <img src={FaceIcon} alt="face-image" className="w-8 max-md:w-6 pt-8 max-sm:pt-6 " />
            <img src={InstaIcon} alt="insta-image" className="w-8 max-md:w-6 pt-8 max-sm:pt-6 " />
            <img src={TweterIcon} alt="tweter-image" className="w-8 max-md:w-6 pt-8 max-sm:pt-6 " />
          </div>
        </div>
        ...
        <p className='text-lg max-lg:px-6 max-lg:pb-6'>
          ...
          sitadad Lorem ipsum  ipsum dolor sitadad Lorem ipsum dolor
          sitadad Lorem ipsum dolor sitadad Lorem ipsum dolor Lorem ipsum dolor
          sitadad Lorem ipsum dolor sitadad Lorem ipsum dolor sitadad Lorem
          ipsum  ipsum dolor sitadad Lorem ipsum Lorem ipsum dolor
          sitadad Lorem ipsum orem ipsum dolor sitadad Lorem ipsum dolor sitadad
          Lorem ipsum dolor sitadad Lorem ipsum dolor Lorem ipsum dolor sitadad
          Lorem ipsum dolor sitadad Lorem ipsum dolor sitadad Lorem ipsum Lorem
          ...
          sitadad Lorem ipsum dolor sitadad Lorem ipsum dolor
        </p>
      </div>
