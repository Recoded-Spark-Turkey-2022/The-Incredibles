...
function NotFoundPage() {
  return (
    <section name="404" className="bg-emerald-50">
      <Container>
      <div name='error-body' className="flex sm:justify-between max-lg:flex-col-reverse max-lg:items-center max-lg:text-center md:px-5">
          ...
          <div name='navcontact' className="text-center lg:w-1/2 max-lg:w-full">
            <h2 className='font-bold md:text-7xl text-cyan-600 text-5xl my-5'>Oh, no!</h2>
            <h1 className='text-cyan-600 py-4 font-bold sm:text-4xl  text-2xl'>Error 404</h1>
            <p className='text-lg my-5 text-rose-400'>
              The page you are looking for might have been removed, had its name
              changed or is temporarily unavailable...
            </p>
            <h3 className='text-lg my-5 text-rose-400'>If the problem you faced remains, you can contact us here:</h3>
